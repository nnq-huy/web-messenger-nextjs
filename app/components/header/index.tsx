...
const Header = ({ children }: { children: React.ReactNode }) => {
	...
	return <>
        <header className="h-20 flex flex-row container mx-auto max-w-full items-center px-2 py-1 justify-between bg-gray-100 dark:bg-slate-800 shadow-md sticky top-0">
            ...
            <nav className=" flex items-center sm:w-10 md:w-auto overflow-hidden">
                <div className="md:hidden">
			        <button className="navbar-burger flex items-center text-indigo-600 dark:text-gra p-3">
			        	<BsMenuApp/>
			        </button>
		        </div>
